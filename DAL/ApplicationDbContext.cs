...
namespace DAL
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, string>
    {
        ...
        public DbSet<GoodsSet> GoodsSets { get; set; }
        public DbSet<GoodsInSet> GoodsInSets { get; set; }
        public DbSet<SetOrder> SetOrders { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<GoodsInSet>().HasKey(gs => new { gs.IdGoods, gs.IdSet });
        }
