    ...
    public class DatabaseInitializer : IDatabaseInitializer
    {
        ...
        public async Task SeedAsync()
        {
            ...
            if (!await _context.Users.AnyAsync())
            {
                ...
                await CreateUserAsync("admin", "111111", "Administrator", "admin@admin.com", "+1 (123) 000-0000", new string[] { adminRoleName });
                await CreateUserAsync("user", "111111", "Inbuilt Standard User", "user@user.com", "+1 (123) 000-0001", new string[] { userRoleName });
