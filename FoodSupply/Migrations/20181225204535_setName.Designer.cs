...
namespace FoodSupply.Migrations
{
    ...
    [Migration("20181225204535_setName")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Models.GoodsInSet", b =>
                {
                    ...
                    b.HasKey("IdGoods", "IdSet");

                    b.HasIndex("IdSet");

                    b.ToTable("GoodsInSets");
                });

            modelBuilder.Entity("DAL.Models.GoodsSet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DAL.Models.SetOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DAL.Models.GoodsInSet", b =>
                {
                    ...
                    b.HasOne("DAL.Models.GoodsSet", "GoodsSet")
                        .WithMany()
                        .HasForeignKey("IdSet")
                        .OnDelete(DeleteBehavior.Cascade);
                });
